...
## <a id="asynchronous-process">Participation is mainly slow and asynchronous mailing list traffic</a>
The IETF is a global organisation with its participants spread across so many different timezones. Added to this, most IETF participants are volunteers with other responsibilities to balance. With that in mind, it is important to understand that the IETF cannot operate in realtime except when it meets in person. 
...
## <a id="meetings">Meetings support, not replace, the mailing list process</a>
...
## <a id="finding-the-context">The context is in the relevant Internet-Drafts, related RFCs and list archives</a>
