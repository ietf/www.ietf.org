...
This guide focuses on the process once ideas are determined to be within the scope of the IETF. The IETF also works on specifications that are within its scope but not Internet Standards. This page includes some information about those to provide additional clarity about and context for its work on standards. 

# <a id="overview">Overview

The IETF Standards process starts when an individual (or individuals) shares an idea, usually in the form of an Internet-Draft ([I-D](https://www.ietf.org/participate/ids/)) document, for further discussion within the IETF community. The [Bringing new work to the IETF webpage](https://www.ietf.org/process/new-work/) provides more detail about how a new idea or proposed work may be introduced to the IETF. The process  Not all ideas that start their way through the IETF process are published as an RFC. and not all RFCs are Internet Standards. An IETF RFC is produced when, as determined by the Internet Engineering Steering Group ([IESG](https://www.ietf.org/about/groups/iesg/)), there is consensus that an I-D ought to be published in the IETF stream of the RFC document series. Not all IETF RFCs describe Internet Standards.
...
The IETF standards process involves a number of different groups, the most central of which are summarized below. [RFC 9281](https://www.rfc-editor.org/rfc/rfc9281.html) provides a more complete description of these and other groups.

## <a id="wgs">Working Groups

The vast majority of the IETF's work is done in its many Working Groups (WGs), of which there are well over one hundred active at any time. A [dedicated guide to IETF Working Groups](https://www.ietf.org/process/wgs/) explains the basics of how they work, how to participate in one, and what to expect.

## <a id="iesg">Internet Engineering Steering Group (IESG)

The [IESG](https://www.ietf.org/about/groups/iesg/) consists of Area Directors, who review and approve working group documents and candidate documents for publication as an IETF RFC. The IESG as a whole ensures that the documents are of a sufficient quality to be published as RFCs: that they describe their subject matter well, and that there are no outstanding engineering issues that should be addressed before publication. The degree of review will vary with the intended status and perceived importance of the documents.
...
The basic formal definition of the IETF Standards process is provided in RFC 2026, with several more RFCs subsequently published and incorporated into ([BCP 9](https://www.rfc-editor.org/info/bcp9)),  BCP 9 published adding to and amending the process. The IETF process embodies and aims to achieve the IETF’s [mission](https://www.ietf.org/about/introduction/#mission) while adhering to its [principles](https://www.ietf.org/about/introduction/#principles) which include open processes, technical competence, and rough consensus and running code. The intellectual property rules are now separate, in RFC 5378 ([BCP 78](https://www.rfc-editor.org/info/bcp78)) (rights in contributions) and RFC 8179 ([BCP 79](https://www.rfc-editor.org/info/bcp79)) (rights in technology).
...
1. **Internet-Draft (I-D) Authoring**  
   ...
   As an I-D, other individuals can review, discuss, and provide feedback on the ideas it presents. This initial sharing can happen in a variety of ways: informally, as part of a DISPATCH discussion, during a dedicated Birds-of-a-Feather (BoF) session, or in an existing Working Group. Sometimes, I-Ds are shared in a combination of some or all of these ways. Writing an I-D does not guarantee it will be adopted as work within the IETF.

## Working Group Phase

3. **Working Group Call for Adoption**  
   The WG Chairs will A WG will officially adopt an I-D if the topic it covers is in scope of the WG charter and there seems to be sufficient interest and energy to work on it. This step establishes a forum for more formal discussion of an I-D. Sometimes, a Working Group is created to consider an I-D because it is within the IETF’s remit but no active WG charter covers the I-D’s topic. More rarely, an I-D may be sponsored by an Area Director (AD) in which case it is not discussed in any particular WG and this step is not needed.
